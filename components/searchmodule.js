...
const SearchModule = ({
    ...
    var searchMinPrice = ['0', '200', '400', '600', '800', '1000', '1200', '1400', '1600', '1800'];
    var searchMaxPrice = ['400', '600', '800', '1000', '1200', '1400', '1600', '1800', '2000', '2500', '3000', '3500', '4000', '4500', 'No max']
    ...
    return (
        ...
        <Container className="search-module">
            <Form>
                ...
                <Row className="desktop desktop-filterbar">
                    <Col className="col-auto">
                        <TypeAheadDropDown iteams={arrayIndex} defaultSelected={selectedValueInput} onTextChange={onSearchChange} onTextBlur={onTextBlur} className="search-bar" />
                        {/* <Typeahead
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownCloseDistance} onToggle={dropdownOpenDistance}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic-distance" className="dropdown_btn">
                                Distance
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="distance-dropdown">
                                <Container>
                                    <Form.Text className="dropdown-title">Select the Distance</Form.Text>
                                    <Row>
                                        <Col>
                                            <Typeahead
                                                ...
                                                placeholder=""
                                                selected={(selectedDistnaceInput) ? selectedDistnaceInput : []}
                                                minLength={0}
                                                defaultSelected={(selectedDistnaceInput) ? selectedDistnaceInput : []}
                                            />
                                        </Col>
                                    </Row>
                                    <Row style={{ marginTop: '20px' }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={handleDistancePress}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onDistanceCloseButtonclick}>Close</Button>
                                        </Col>
                                    </Row>
                                </Container>
                            </Dropdown.Menu>
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownClose} onToggle={dropdownOpen}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic1" className="dropdown_btn">
                                Price
                            </Dropdown.Toggle>
                            ...
                            <Dropdown.Menu className="price-dropdown">
                                <Container>
                                    ...
                                    <Row>
                                        <Col>
                                            ...
                                            <Typeahead
                                                ...
                                                placeholder="Min"
                                                selected={(selectedMinNuValueInput) ? selectedMinNuValueInput : []}
                                                minLength={0}
                                                defaultSelected={(selectedMinNuValueInput) ? selectedMinNuValueInput : []}
                                            />
                                        </Col>
                                        <Col>
                                            {/* <Form.Group className="mb-3" controlId="formBasicEmail">
                                            ...
                                            <Typeahead
                                                ...
                                                placeholder="Max"
                                                selected={(selectedMaxNuValueInput) ? selectedMaxNuValueInput : []}
                                                minLength={0}
                                                className="max-value-dropdown"

                                                defaultSelected={(selectedMaxNuValueInput) ? selectedMaxNuValueInput : []}
                                            />
                                        </Col>
                                    ...
                                    <Row style={{ marginTop: '20px' }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={onButtonclick}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onCloseButtonclick}>Close</Button>
                                        </Col>
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownCloseOne} onToggle={dropdownOpenOne}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic2" className="dropdown_btn" name="bedandbaths">
                                Beds & Baths
                            </Dropdown.Toggle>
                            ...
                            <Dropdown.Menu className="bb-dropdown">
                                <Container>
                                    ...
                                    <Row style={{ marginTop: "16px" }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={onButtonclickBedAndBath}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onCloseButtonclick}>Close</Button>
                                        </Col>
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownCloseTreeAA} onToggle={dropdownOpenTreeAA}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic4-one" className="dropdown_btn dropdown-toggle btn btn-success" name="typeP">
                                Home Type
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="dogscats-dropdown">
                                <Container>
                                    ...
                                    <Row style={{ marginTop: "16px" }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={onButtonclickType}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onCloseButtonclick}>Close</Button>
                                        </Col>
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownCloseTwo} onToggle={dropdownOpenTwo}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic3" className="dropdown_btn" name="moveIDate">
                                Move-In Date
                            </Dropdown.Toggle>
                                ...
                                <Container>
                                    <Row>
                                        <Form.Group controlId="doj1">
                                            ...
                                            <p className="dropdown-description">Select a date to view listings available on or before this date.</p>
                                            <DatePicker
                                    ...
                                    <Row style={{ marginTop: "16px" }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={onButtonclickDate}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onCloseButtonclick}>Close</Button>
                                        </Col>
                    ...
                    <Col className="col-auto">
                        <Dropdown className="d-inline" show={dropdownCloseTree} onToggle={dropdownOpenTree}>
                            <Dropdown.Toggle variant="success" id="dropdown-basic4" className="dropdown_btn" name="petA">
                                Pets
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="dogscats-dropdown">
                                <Container>
                                    ...
                                    <Row style={{ marginTop: "16px" }}>
                                        <Col>
                                            <Button variant="primary" type="button" className="INdropdown-button" onClick={onButtonclickPets}>Apply</Button>
                                            <Button variant="secondary" type="button" className="INdropdown-button-close" onClick={onCloseButtonclick}>Close</Button>
                                        </Col>
            ...
            <Row className="mobile">
                <Col className="mobile-logo col-4"><Navbar.Brand href="https://www.purepm.co/">
                    <img
                        src={logo}
                        width="90"
                        height="auto"
                ...
                <Navbar.Brand className='location-col col-4 flex-center' onClick={handleShowModal}>
                    <Button className='location-button'>PURE Locations</Button>
                </Navbar.Brand>

                <Modal show={showModal} onHide={handleCloseModal} size="xl" backdrop="false" className="referencelinks-dropdown" >
              ...
              <Modal.Title><p className='location-title'>Locations</p></Modal.Title>
                ...
                <Col className="hamburger-menu col-4">
                    ...
                    <Modal show={navmodalShow} onHide={navCloseModal} dialogClassName="listing-modal">
                        <Modal.Header closeButton>
                        ...
                        <Modal.Body>
                            ...
                            <Row>
                                ...
                                <div className="home-types">
                                    ...
                                    <div className="home-type-mobile">
                                        {renderList}
                                    </div>
                                </div>
                            </Row>
                            ...
                            <Row>
                                <Col>
                                    <Button variant="primary" type="button" className="INdropdown-button" onClick={mobileSubmit} style={{ marginTop: '30px' }}>Apply</Button>
                                </Col>
                            </Row>
